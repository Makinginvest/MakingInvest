  ...
  return (
    <Navbar p={2} hiddenBreakpoint='md' hidden={!isOpen} width={{ md: 240, lg: 270 }} className=''>
      <Navbar.Section grow component={ScrollArea} type='always' className='pt-2'>
        ...
        <NavbarLink link='/offerings' title='ICO' iconifyData='fluent:reward-12-filled' />
...
function NavbarLinkSub({ link, title }: INavarLink) {
  ...
  return (
    <div onClick={() => router.push(link)} className='flex cursor-pointer hover:bg-slate-100 hover:dark:bg-slate-800 pl-[60px] py-[1.5px]  transition-all'>
