...
async def update_mongodb_indexes():
    try:
        ...
        timeframes_crypto = ["5m", "15m", "30m", "1h", "2h", "3h", "4h", "6h", "8h", "12h", "1d"]
        timeframes_stocks = ["5m", "15m", "30m", "1h", "2h", "4h", "6h", "12h", "1d"]
        timeframes_forex = ["5m", "15m", "30m", "45m", "1h", "2h", "4h", "6h", "12h", "1d"]
