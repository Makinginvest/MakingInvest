...
async def get_mongodb_data_historical_v1(symbol, hist_coll_name=None, timeframe="15m", limit=20000, dt_start: datetime = None, dt_end: datetime = None) -> pd.DataFrame:
