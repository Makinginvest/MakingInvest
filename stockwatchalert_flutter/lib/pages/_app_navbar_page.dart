...
import '../libraries/custom_navigation_bar/custom_navigation_bar_item.dart';
import '../libraries/custom_navigation_bar/custome_navigation_bar.dart';
      ...
      bottomNavigationBar: Container(
        ...
        child: MediaQuery.removePadding(
          ...
          child: CustomNavigationBar(
            ...
            backgroundColor: context.isDarkMode ? AppColors.dark1 : Colors.grey.shade300,
            borderRadius: Radius.circular(0.0),
            opacity: 1,
            ...
            items: [
              CustomNavigationBarItem(
                ...
                title: Text('Home', style: TextStyle(color: getIconColor(0), fontSize: 13, height: 0, fontWeight: FontWeight.w900)),
              ),
              CustomNavigationBarItem(
                icon:
                    SvgPicture.asset('assets/svg/analysis.svg', colorFilter: ColorFilter.mode(getIconColor(1), BlendMode.srcIn), height: getIconHeight(1), width: getIconHeight(1)),
                title: Text('Analysis', style: TextStyle(color: getIconColor(1), fontSize: 13, height: 0, fontWeight: FontWeight.w900)),
              ),
              CustomNavigationBarItem(
                icon:
                ...
                title: Text('Signals', style: TextStyle(color: getIconColor(2), fontSize: 13, height: 0, fontWeight: FontWeight.w900)),
              ),
              CustomNavigationBarItem(
                icon:
                ...
                title: Text('Tracker', style: TextStyle(color: getIconColor(3), fontSize: 13, height: 0, fontWeight: FontWeight.w900)),
              ),
              CustomNavigationBarItem(
                ...
                title: Text('Account', style: TextStyle(color: getIconColor(4), fontSize: 13, height: 0, fontWeight: FontWeight.w900)),
              ),
            ],
          ),
        ),
