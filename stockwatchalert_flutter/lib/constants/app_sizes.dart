class AppSIZES {
  ...
  static double lgRadius = 20;
  static double xlRadius = 24;
  static double fullRadius = 999;

  static double textFormFieldHeight = 44;
  static double textFormFieldRadius = 16;
