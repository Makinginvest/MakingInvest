                    ...
                    SliverOverlapAbsorber(
                      ...
                      sliver: SliverAppBar(
                        ...
                        title: Row(
                          ...
                          children: [
                            Container(
                              child: Text('MAKING INVEST', style: TextStyle(fontSize: 20, fontWeight: FontWeight.w700, color: AppCOLORS.white)),
                            ),
                            Spacer(),
                            Center(
                              child: ZCard(
                            ...
                            ZCard(
                              ...
                              child: Text('Results', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w900, color: AppCOLORS.yellow)),
