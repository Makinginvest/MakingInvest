...
class _AppNavbarPageState extends State<AppNavbarPage> {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: CustomNavigationBar(
        ...
        items: [
          ...
          CustomNavigationBarItem(
            icon: SvgPicture.asset('assets/svg/ico.svg', colorFilter: ColorFilter.mode(getIconColor(3), BlendMode.srcIn), height: getIconHeight(3), width: getIconHeight(2)),
            title: Text('ICO', style: TextStyle(color: getIconColor(3), fontSize: 12)),
          ),
          CustomNavigationBarItem(
  ...
  Color getIconColor(int index) {
    ...
    if (selectedIndex == index) return isLightTheme ? AppCOLORS.yellow : AppCOLORS.yellow;
    return color;
  }
