...
from app.helpers._functions_mongodb.crypto__mongodb_update import crypto_update_all_mongodb_historical_all, crypto_update_all_mongodb_historical_recent
...
async def route(apikey: str = None):
    try:
        ...
        result = await crypto_update_all_mongodb_historical_all(timeframe="15m", lookback_days=30, lookback_months=15, pull_monthly=True)
