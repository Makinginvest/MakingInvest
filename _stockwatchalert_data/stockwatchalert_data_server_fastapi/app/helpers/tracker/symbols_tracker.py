...
import pandas as pd
from app.helpers._functions_mongodb.a_mongodb_data import get_mongodb_data_historical
from app.helpers._functions.crypto__functions import get_USDT_symbols_by_value
...
async def get_symbols_trackers_forex():
    try:
        # get symbols
        symbols = await get_USDT_symbols_by_value("_project/datasets/data/_data_symbols_forex_oanda_main.csv")
        symbols = symbols[:200]
        # symbols = ["EURUSD"]
